...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Deterministic/abrupt/additive faults
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Select the deterministic response of the EMS under faults
mode_sel=1;
fprintf('Deterministic/abrupt/additive faults(%g)\n', mode_sel);
%***************************
%Deterministic responses check
%***************************
...
%***************************************
%Deterministic/Abrupt/additive conditions
%Fault free case (ff)
%***************************************
%Sensor fault time
...
%*********************************************************
% Deterministic/Abrupt/additive Fault conditions
...
%*******************************************
display('Deterministic/abrupt/additive fault test')
%Sensor fault time
current_fault_time=7;
...
display('Deterministic/abrupt/additive faults test finished.')
...
%***************************
mode_sel=2;
fprintf('Stochastic/abrupt/additive fault test.(%d)',mode_sel)

%DUMMY VARIABLES(slope of the incipient fault)
i_slope=20;
v_slope=0.5;
a_slope=20;
...
%Threshold values - for stochastic response
display('Threshold values - for stochastic response')
% V_th_i=0.01%0.03%1e-4;
% V_th_v=5e-5%1e-5%1e-5;
% V_th_a=2.4e-3%0.0028%4e-5;
...
fprintf('Current threshold:%g\nVelocity threshold:%g\nAcceleration threshold:%g\n'...
    ,V_th_i,V_th_v,V_th_a);
%***************************************
%Stochastic/Abrupt/additive conditions
%Fault free case (ff)
%***************************************
%Sensor fault time
current_fault_time=7;
...
% axis tight
% 
% max(i_res_ff(2:end,1))
% max(v_res_ff(2:end,1))
% max(a_res_ff(2:end,1))


%*********************************************************
%Stochastic/Abrupt/additive Fault conditions
%Current Abrupt fault case (caf)
%*********************************************************
display('Stochastic/abrupt/additive fault test.')
%Sensor fault time
current_fault_time=1;
velocity_fault_time=7;
acceleration_fault_time=7;
...
% 
% figure
% plot(sim_time,i_res_cvaaf),grid on;
% title('Current Residual')
% legend('Current residual','Current Threshold','location','northwest')
% axis tight
