...
title('current-velocity fincipient fault profile')
axis tight
...
%*******************************************************
%Deterministic/incipient/additive Fault conditions - current-velocity-acceleration fault case (cvaaf)
%*******************************************************
%Sensor fault time
...
%***************************************************
% Stochastic/incipient/additive Fault conditions
% Velocity fault case (vaf)
%***************************************************
%Sensor fault time
current_fault_time=7;
